...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget _buildNavItem(BuildContext context, int index, IconData icon, IconData activeIcon, String label, {bool disabled = false}) {
    ...
    return Semantics(
      ...
      label: label,
      child: ScaleOnTap(
        onTap: disabled ? null : () => setState(() => _currentIndex = index),
        child: AnimatedContainer(
          duration: const Duration(milliseconds: 200),
          padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
          decoration: BoxDecoration(
            color: isSelected && !disabled ? primaryColor.withOpacity(0.1) : Colors.transparent,
